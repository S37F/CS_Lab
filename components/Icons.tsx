...
export const BrainCircuitIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2a4.5 4.5 0 0 0-4.5 4.5v1.4a3.5 3.5 0 0 0-2.1 3.1c0 1.9 1.6 3.5 3.5 3.5h1.1a3.5 3.5 0 0 1 3.5 3.5v1.4A4.5 4.5 0 1 0 12 2z"></path>
        <path d="M12 2a4.5 4.5 0 0 1 4.5 4.5v1.4a3.5 3.5 0 0 1 2.1 3.1c0 1.9-1.6 3.5-3.5 3.5h-1.1a3.5 3.5 0 0 0-3.5 3.5v1.4A4.5 4.5 0 1 1 12 2z"></path>
        <path d="M12 14.5a2.5 2.5 0 0 0-2.5 2.5V18a2.5 2.5 0 0 0 5 0v-1.1a2.5 2.5 0 0 0-2.5-2.5z"></path>
        <path d="M14.1 2.9a2.5 2.5 0 0 0-4.2 0"></path><path d="M18.1 6.9a2.5 2.5 0 0 0-4.2 0"></path>
        <path d="M9.9 2.9a2.5 2.5 0 0 1 4.2 0"></path><path d="M5.9 6.9a2.5 2.5 0 0 1 4.2 0"></path>
    </svg>
);

export const MiningIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M15 18H9a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2z"></path>
        <path d="M12 22v-4"></path><path d="M10 6V4a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v2"></path>
        <path d="M5 14H3"></path><path d="M21 14h-2"></path>
    </svg>
);
