...
import { getCscanDiskSimulation } from '../../services/cscanDiskService';
...
const CSCANSimulator: React.FC = () => {
    ...
    const runSimulation = useCallback(() => {
        ...
        if (requests.length > 0 && startPos >= 0 && startPos < maxCylinder) {
            const simData = getCscanDiskSimulation(requests, startPos, maxCylinder);
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
                <Card title="Disk Head Movement (Circular SCAN)">
                    <div className="p-4">
